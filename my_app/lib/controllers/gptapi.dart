...
Future<List<Map<String, dynamic>>> gptapicall(
    String taskheading, String taskdesc) async {
  const String apiKey =
      "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"; // GPT API Key
  ...
  try {
    if (response.statusCode == 200) // if the response if OK then
    {
      ...
      final String result = res['choices'][0]['message']
          ["content"]; // extract the result result from the content
