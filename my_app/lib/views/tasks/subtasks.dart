...
class _SubtaskPageState extends State<SubTaskPage> {
  ...
  void initState() {
    ...
    _headingController = TextEditingController(
        text: widget.subtasks[subtaskIndex]['subheading']);
    _descriptionController =
        TextEditingController(text: widget.subtasks[subtaskIndex]['content']);
  }
  ...
  void _saveTask() async {
    ...
    await editSubTask(
        ...
        widget.subtasks[subtaskIndex]['subheading'],
        taskheading);
    setState(() {
    ...
    Navigator.of(context)
        .pop(); // Go back to the previous screen with the updated list
  }
  ...
  Future<void> _deleteTask() async {
    ...
    await deleteSubTask(
        username, taskheading, widget.subtasks[subtaskIndex]['subheading']);
    setState(() {
  ...
  void _completeSubTask() async {
    ...
    if (isCompletedTask) {
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (context) =>
              CompletedTaskPage(username: username, task: thisTask),
        ),
      );
    } else {
      Navigator.pushReplacement(
      ...
      appBar: AppBar(
        ...
        title: const Row(
          ...
          children: [
            Padding(
              padding:
                  EdgeInsets.only(right: 35.0), // Adjust the value as needed
              child: Text(
                'Subtask Details',
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: TextField(
                ...
                style: TextStyle(
                    fontSize: 16.0, color: Colors.brown[800]), // Text color
                maxLines: null,
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    showDeleteConfirmationDialog(
                        context, _deleteTask, username, thisTask);
                  },
                ),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ElevatedButton.icon(
                onPressed: () {
                  showCompleteConfirmationDialog(context, _completeSubTask);
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color.fromARGB(255, 255, 215, 100),
                ),
